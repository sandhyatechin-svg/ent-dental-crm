...
export function MedicineForm({ patientId, onMedicineAdded, isLoading, setIsLoading }: MedicineFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // First, find the medicine by name to check stock and get medicine_id
      ...
      if (medicineError || !medicineData) {
        alert(`Medicine "${medicineName.trim()}" not found in inventory. Please check the medicine name.`)
        return
      }
      ...
      alert(`Medicine added successfully! Stock updated: ${medicineData.stock_quantity - qty} remaining`)
    } catch (error) {
